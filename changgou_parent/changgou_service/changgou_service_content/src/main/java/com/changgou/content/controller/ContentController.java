...
public class ContentController {
    ...
    public Result findPage(@RequestBody(required = false)  Content content, @PathVariable  int page, @PathVariable  int size){
    ...
    public Result<List<Content>> findByCategory(@PathVariable Long id){
        ...
        List<Content> contentList = contentService.findList(where);
