...
public class SpuController {
    ...
    public Result save(@RequestBody Goods goods) {
        ...
        return new Result(true, StatusCode.OK, "保存商品信息成功");
    }
    ...
    public Result findGoodBySpuId(@PathVariable Long spuId) {
    ...
    public Result putMany(@RequestBody Long[] ids) {
        ...
        return new Result(true, StatusCode.OK, "批量上架成功" + i + "个商品");
    }

    /**逻辑删除，只是修改删除状态为"1",并非真正意义上的删除
     * @param spuId
     */
    @PutMapping("/logic/delete/{spuId}")
